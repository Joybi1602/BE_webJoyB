...
const createOrder = (newOrder) => {
    return new Promise(async (resolve, reject) => {
        const { orderItems ,paymentMethod, itemsPrice, shippingPrice, totalPrice, fullName, phone, address, city, user, isPaid, paidAt } = newOrder
        try {
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if(order === null) {
                resolve ({
                    status: 'OK',
                    message: 'The order it not defined'
                })
            }
            resolve ({
                status: 'OK',
